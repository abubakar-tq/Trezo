...
const extra = {
  ...
  // Allow local override variables so production values can remain unchanged in .env.
  supabaseUrl:
    process.env.EXPO_PUBLIC_SUPABASE_OVERRIDE_URL
    ?? process.env.EXPO_PUBLIC_SUPABASE_URL
    ?? "",
  supabaseAnonKey:
    process.env.EXPO_PUBLIC_SUPABASE_OVERRIDE_ANON_KEY
