...
// LINK is base-sepolia-only; the per-chain gate lives in TokenDetailModal's action row.
const TESTNET_TRADEABLE_SYMBOLS = new Set(["ETH", "USDC", "USDT", "DAI", "WETH", "WBTC", "LINK"]);
